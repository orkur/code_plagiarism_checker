...
std::unordered_map<std::string, double> similarity_between_graphs(const Node& a, const Node& b, const Graph& graph1,
    const Graph& graph2, bool do_strict, bool do_levenshtein, bool do_ted);